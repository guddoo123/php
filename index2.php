...
<nav class="navbar navbar-inverse"  style="position: sticky; top:0; z-index:8; height: 80px; ">
  <div class="container-fluid" style="    padding-top: 6px;">
    <div class="navbar-header" style="margin-top: -16px; height: 85px;">
      <img src="images/logo3.png" alt="quickjob-lgo" title="quickjob-lgo" />
                ...
                <div class="col-lg-10">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                               ...
                               <select class="form-control search-slt" name="country" id="country" required="">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                             ...
                             <select class="form-control search-slt" name="state" id="state" required="">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                               ...
                               <select class="form-control search-slt" name="city" id="city" required="">
  ...
  <div class="centered" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);  ">
    <h3 style="text-transform: uppercase; font-weight: 800;">Are you a service provider?</h3>
     <p style="margin-top: 50px;">Come and join the QuickQuick Experts Team to offer quality service experience to our customers.</p>
          <br>
          <a href="joinus.php"><button type="button" class="btn btn-default"  style="color: #333; background-color: #ffca08;border-radius:40px;">Join Us</button></a>
  </div>
 </div>
</div>
...
======================================================--> 
    ...
    <center>
        <div id="footer-bottom" style=" background-color: rgba(37, 37, 37, 37); padding: 30px 0;  ">
            <div class="container" style="border-top: 1px solid #424242;">
                <div class="row">
                    <div class="col-md-12" >
